...
flag_Cycle_A = false, flag_Cycle_B = false, flag_OTA_begin = false, flag_ThSp_time = false, flag_IFTTT_time = false, flag_Setup = false;
...
int
background_color = tft.color565(0, 0, 0),  //Цвет заливки экрана
text_color,                                //Цвет текста
temp_color,                                //Временный цвет
cycle_count = 60;                          //Счетчик циклов для очистки экран

bool
flag_blinking = true,                     //Флаг наличия обмена
flag_send_now = true;                     //Флаг разрешения Now отправки
