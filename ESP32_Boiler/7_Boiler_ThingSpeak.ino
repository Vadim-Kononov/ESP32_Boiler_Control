...
{  
  ...
  data_to_send += String(now_Store[ROLE].temp_room);
  data_to_send += F(",");
  data_to_send += String(now_Store[ROLE].press_room);
  data_to_send += F(",");
  data_to_send += String(now_Store[ROLE].hum_room);
  data_to_send += F(",");
  data_to_send += String(now_Store[ROLE].temp_outdoor);
  data_to_send += F(",");
  data_to_send += String(now_Store[ROLE].hum_outdoor);
  data_to_send += F(",");
  data_to_send += String(position_dec);
  data_to_send += F(",");
  data_to_send += String(now_Store[ROLE].temp_water);
  data_to_send += F(",");
  data_to_send += String(now_Store[ROLE].temp_gas); 
  data_to_send += F(",");
  data_to_send += F("0,");
  data_to_send += F("0,");
  data_to_send += F("0,");
